...
<head>
  <meta charset="UTF-8">
  <title>registr/auth</title>
  <link rel="stylesheet" href="http://localhost/Task-Manager/assets/css/auth.css">
	...
	<div id="panel-box">
		<div class="panel">
			<div class="auth-form on" id="login">
				...
				<form action="http://task-manager.test/auth.php?action=login" method="POST">
			...
			<div class="auth-form" id="signup" >
				...
				<form action="http://task-manager.test/auth.php?action=register" method="POST">
